...
void displayScreen() {
  ...
  switch (currentScreen) {
    ...
    case 1: // Rolling graph screen
      ...
      display.drawLine(GRAPH_X, GRAPH_Y - graphData[0], GRAPH_X + 1, GRAPH_Y - graphData[1], WHITE);
      for (int i = 1; i < GRAPH_WIDTH - 1; i++) {
        display.drawLine(GRAPH_X + i, GRAPH_Y - graphData[i], GRAPH_X + i + 1, GRAPH_Y - graphData[i + 1], WHITE);
      }
